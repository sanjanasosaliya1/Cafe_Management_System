...
<body>
    <header class="header" id="header">
        ...
        <div class="header__img">
            <a href="/cafe_management_system/admin/viewProfile.php"><img src="/cafe_management_system/admin/assetsForSideBar/img/profilePic.jpg" alt="" srcset=""></a>
        </div>
    </header>
    ...
    <div class="l-navbar" id="nav-bar">
        <nav class="nav">
            <div>
                <a href="index.php" class="nav__logo nav__link">
            ...
            <a href="partial/_logout.php" class="nav__link">
